...
-export([createGame/3, checkState/2, getGameBoard/2, setBoard/3, makeMove/6, rematch/1, getLeaderBoard/0]).
...
getGameBoard(GameId, GamePlayerId) ->
  ...
  OpposingGamePlayers = db_util:getRecordsByMatch({game_players,'_',GameId,IsOpposingPlayer1,'_','_','_'}),
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
rematch(GameId) ->
  [GamePlayer1] = db_util:getRecordsByMatch({game_players,'_',GameId,1,'_','_','_'}),
  [GamePlayer2] = db_util:getRecordsByMatch({game_players,'_',GameId,0,'_','_','_'}),
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
createGame(IsPlayer1, GamePlayerEmail, OpposingPlayerEmail) 
when IsPlayer1                  >= 0,
     IsPlayer1                  =< 1,
...
setBoard(GameId, GamePlayerId, BoardPositions) ->
  ...
  if 
    ...
    PlayerBoardStatus =:= boardSet ->
      ...
      GamePlayersWithBoardSet = db_util:getRecordsByMatch({game_players,'_',GameId,'_',true, '_', '_'}),
